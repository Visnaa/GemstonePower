...
public class SawmillRecipe implements EnergyRecipe
{
    ...
    public SawmillRecipe(ResourceLocation id, Ingredient input, ItemStack output, int count, int processingTime, int energyUsage)
    {
        this.id = id;
        this.input = input;
        this.output = output;
    ...
    public static class Serializer implements RecipeSerializer<SawmillRecipe>
    {
        ...
        public SawmillRecipe fromJson(ResourceLocation recipeID, JsonObject json)
        {
            ...
            return new SawmillRecipe(recipeID, input, output, count, processingTime, energyUsage);
        }
        ...
        public SawmillRecipe fromNetwork(ResourceLocation recipeID, FriendlyByteBuf buffer)
        {
            ...
            return new SawmillRecipe(recipeID, inputs.get(0), output, count, processingTime, energyUsage);
        }
