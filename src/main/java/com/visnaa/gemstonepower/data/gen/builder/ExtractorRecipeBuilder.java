...
public class ExtractorRecipeBuilder implements RecipeBuilder
{
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId)
    {
        ...
        consumer.accept(new ExtractorRecipeBuilder.Result(recipeId, this.input, this.output, this.count, this.processingTime, this.energyUsage, this.advancement, new ResourceLocation(recipeId.getNamespace(), "recipes/" + recipeId.getPath())));
    }
