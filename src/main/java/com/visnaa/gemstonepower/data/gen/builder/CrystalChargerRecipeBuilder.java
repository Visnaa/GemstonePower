...
public class CrystalChargerRecipeBuilder implements RecipeBuilder
{
    ...
    public void save(RecipeOutput output, ResourceLocation recipeId)
    {
        ...
        output.accept(new CrystalChargerRecipeBuilder.Result(recipeId, this.input, this.output, this.count, this.processingTime, this.energyUsage, builder.build(new ResourceLocation(recipeId.getNamespace(), "recipes/" + recipeId.getPath()))));
    }
