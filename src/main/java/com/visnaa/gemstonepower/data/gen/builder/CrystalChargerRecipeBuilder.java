...
public class CrystalChargerRecipeBuilder implements RecipeBuilder
{
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId)
    {
        ...
        consumer.accept(new CrystalChargerRecipeBuilder.Result(recipeId, this.input, this.output, this.count, this.processingTime, this.energyUsage, this.advancement, new ResourceLocation(recipeId.getNamespace(), "recipes/" + recipeId.getPath())));
    }
    ...
    public static class Result implements FinishedRecipe
    {
        ...
        {
            return new ResourceLocation(GemstonePower.MOD_ID, this.id.getPath() + "_using_crystal_charger");
        }
