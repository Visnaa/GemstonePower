...
public class SawmillRecipeBuilder implements RecipeBuilder
{
    ...
    public SawmillRecipeBuilder(Ingredient input, Item output, int count, int processingTime, int energyUsage)
    {
        this.input = input;
        this.output = output;
        this.count = count;
    ...
    public static SawmillRecipeBuilder create(Ingredient input, Item output, int count, int processingTime, int energyUsage)
    {
        return new SawmillRecipeBuilder(input, output, count, processingTime, energyUsage);
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId)
    {
        ...
        consumer.accept(new SawmillRecipeBuilder.Result(recipeId, this.input, this.output, this.count, this.processingTime, this.energyUsage, this.advancement, new ResourceLocation(recipeId.getNamespace(), "recipes/" + recipeId.getPath())));
    }
    ...
    public static class Result implements FinishedRecipe
    {
        ...
        {
            return new ResourceLocation(GemstonePower.MOD_ID, this.id.getPath() + "_using_sawmill");
        }
