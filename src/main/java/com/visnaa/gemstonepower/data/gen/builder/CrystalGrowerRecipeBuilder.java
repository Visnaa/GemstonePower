...
public class CrystalGrowerRecipeBuilder implements RecipeBuilder
{
    ...
    public CrystalGrowerRecipeBuilder(Ingredient input, Item output, int count, int processingTime, int energyUsage)
    {
        this.input = input;
        this.output = output;
        this.count = count;
    ...
    public static CrystalGrowerRecipeBuilder create(Ingredient input, Item output, int count, int processingTime, int energyUsage)
    {
        return new CrystalGrowerRecipeBuilder(input, output, count, processingTime, energyUsage);
    }
    ...
    public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId)
    {
        ...
        consumer.accept(new CrystalGrowerRecipeBuilder.Result(recipeId, this.input, this.output, this.count, this.processingTime, this.energyUsage, this.advancement, new ResourceLocation(recipeId.getNamespace(), "recipes/" + recipeId.getPath())));
    }
