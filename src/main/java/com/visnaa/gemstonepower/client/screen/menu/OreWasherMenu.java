...
public class OreWasherMenu extends AbstractContainerMenu
{
    ...
    private final RecipeType<? extends OreWasherRecipe> recipeType;

    public OreWasherMenu(int id, Inventory inventory)
    {
        this(ModContainers.ORE_WASHER.get(), ModRecipes.ORE_WASHER_RECIPE, id, inventory, new SimpleContainer(5), new SimpleContainerData(4));
    }

    public OreWasherMenu(int id, Inventory inventory, Container container, ContainerData data)
    {
        this(ModContainers.ORE_WASHER.get(), ModRecipes.ORE_WASHER_RECIPE, id, inventory, container, data);
    }

    protected OreWasherMenu(MenuType<?> menu, RecipeType<? extends OreWasherRecipe> recipe, int id, Inventory inventory, Container container, ContainerData data)
    {
        super(menu, id);
        ...
        this.addSlot(new Slot(container, 1, 100, 28));
        this.addSlot(new Slot(container, 2, 119, 28));
        this.addSlot(new Slot(container, 3, 100, 47));
        this.addSlot(new Slot(container, 4, 119, 47));
    ...
    public ItemStack quickMoveStack(Player player, int index)
    {
        ...
        final int blockEntitySlotCount = 5;
    ...
    {
        return this.level.getRecipeManager().getRecipeFor((RecipeType<OreWasherRecipe>) this.recipeType, new SimpleContainer(itemStack), this.level).isPresent();
    }
