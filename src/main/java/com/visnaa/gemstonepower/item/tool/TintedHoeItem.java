...
public class TintedHoeItem extends HoeItem implements Tintable
{
    private final int color;

    public TintedHoeItem(ToolMaterial material, int damage, float multiplier, Properties properties)
    {
