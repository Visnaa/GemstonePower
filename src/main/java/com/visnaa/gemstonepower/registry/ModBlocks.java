...
public final class ModBlocks
{
    ...
    public static final RegistryObject<Block> ALUMINUM_CABLE = BLOCKS.register("aluminum_cable", () -> new AluminumCableBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
    public static final RegistryObject<Block> TIN_WIRE = BLOCKS.register("tin_wire", () -> new TinWireBlock(BlockBehaviour.Properties.copy(Blocks.WHITE_WOOL).noOcclusion()));
