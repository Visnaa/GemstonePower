...
public class MachineConfigSyncC2S
{
    ...
    public MachineConfigSyncC2S(MachineConfigs left, MachineConfigs right, MachineConfigs back, MachineConfigs up, MachineConfigs down, BlockPos pos)
    {
        this.left = left;
        this.right = right;
        this.back = back;
    ...
    public void handle(NetworkEvent.Context context)
    {
        context.enqueueWork(() -> {
            ...
            {
                blockEntity.sendConfigToClients(left, right, back, up, down);
            }
        });
