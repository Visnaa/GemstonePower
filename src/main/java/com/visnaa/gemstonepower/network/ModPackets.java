...
public class ModPackets
{
    ...
    public static void register()
    {
        ...
        channel.messageBuilder(MachineConfigSyncS2C.class, id(), NetworkDirection.PLAY_TO_CLIENT)
        ...
        channel.messageBuilder(MachineConfigSyncC2S.class, id(), NetworkDirection.PLAY_TO_SERVER)
