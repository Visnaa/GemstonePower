...
{
    public static final ResourceLocation UID = new ResourceLocation(GemstonePower.MOD_ID, "sawing");
    public static final ResourceLocation TEXTURE = new ResourceLocation(GemstonePower.MOD_ID, "textures/gui/sawmill_gui.png");
    ...
    {
        return GemstonePowerJEIPlugin.SAWMILL_CATEGORY;
    }

    @Override
    public Component getTitle()
    {
        return Component.literal("Sawing");
    }
    ...
    {
        this.progressAnimated.draw(graphics, 23, 2);
        this.energyAnimated.draw(graphics, 97, 1);
        if (MachineScreen.isMouseInArea((int) mouseX, (int) mouseY, 23, 2, 27, 13))
